...
rm(list = ls())
gc()
pacman::p_load(tidyverse,qs,data.table,beepr)
...
serialized_files_names <- paste0(seq(as.Date("2023/1/1"), by = "month", length.out = 12),".qs")
...
# Se sugiere revisar que el orden de los archivos sea el correcto (secuencial, en este caso), ya que de ello depende una correcta asignaci�n de los nombres de los archivos a guardar
